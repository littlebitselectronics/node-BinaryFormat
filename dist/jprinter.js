...
(function () {
	...
	function inherit(obj) {
		if ('create' in Object) {
			...
			var ClonedObject = function ClonedObject() {};
	...
	jPrinter.prototype.structure = {
		uint8: function uint8(data) {
			this.view.writeUint8(data);
		},
		uint16: function uint16(data) {
			this.view.writeUint16(data);
		},
		uint32: function uint32(data) {
			this.view.writeUint32(data);
		},
		int8: function int8(data) {
			this.view.writeInt8(data);
		},
		int16: function int16(data) {
			this.view.writeInt16(data);
		},
		int32: function int32(data) {
			this.view.writeInt32(data);
		},
		float32: function float32(data) {
			this.view.writeFloat32(data);
		},
		float64: function float64(data) {
			this.view.writeFloat64(data);
		},
		char: function char(data) {
			this.view.writeChar(data);
		},

		string: function string(length, data) {
			this.view.writeString(data);
		},

		array: function array(type, length, data) {
		...
		seek: function seek(position, block) {
